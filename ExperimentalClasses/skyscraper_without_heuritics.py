...
This is the Skyscraper class without the heuristics (minimum remaining value and minimum assigned variable heuristics).
...
class Skyscraper(Puzzle):
  ...
  def successors(self):
    # Overrides the successors method from the Puzzle class to implement a simple selection variable without heuristics.
